  ...
  return (
    <>
      <section className="bg-navy text-offWhite px-8 md:px-0">
        <div className="container mx-auto py-20 flex flex-col gap-6 items-center justify-center">
          <SlidingInComponent delay={0} class="mb-5">
            <h1 className="text-4xl tracking-wider ">Services</h1>
          </SlidingInComponent>
          ...
          <SlidingInComponent delay={0.2}>
            <ul className="flex text-2xl mt-5 flex-row w-full gap-6 items-center justify-center">
              <li>
